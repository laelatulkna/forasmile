            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                <div class="card-header pb-0 text-start">
                  <h4 class="font-weight-bolder">Token</h4>
                  <p class="mb-0">Masukkan Token yang telah dikirimkan ke email Anda untuk mereset kata sandi.</p>
                </div>
                <div class="card-body">
                  ...
                  <form role="form" method="POST" action="{{ route('token-verifikasi') }}">
                    @csrf
                    <div class="mb-3">
                      <input type="hidden" name="email" class="form-control form-control-lg" placeholder="Email" value="{{ $email }}" aria-label="Email">
                    </div>

                    <div class="mb-3">
                      <input type="number" name="token" class="form-control form-control-lg" placeholder="Token" aria-label="token" required>
                    </div>

                    <div class="text-center">
                      <button type="submit" class="btn btn-lg btn-primary btn-lg w-100 mb-0">Submit</button>
                    </div>
