            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                <div class="card-header pb-0 text-start">
                  ...
                  <p class="mb-0">Masukkan Email Untuk Mereset Kata Sandi.</p>
                </div>
                <div class="card-body">
                  ...
                  <form role="form" method="GET" action="{{ route('token') }}">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-lg btn-primary btn-lg w-100 mb-0">Kirim Token</button>
                    </div>
