            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                <div class="card-header pb-0 text-start">
                  <h4 class="font-weight-bolder">Login For A Smile</h4>
                  <p class="mb-0">Masukan Username Dan Password Untuk Masuk Ke Akun Anda.</p>
                </div>
                <div class="card-body">
                  ...
                  <form role="form" method="POST" action="{{ route('login') }}">
                    ...
                    <p><a href="{{ route('lupa-sandi') }}">Lupa kata sandi?</a></p>

                    <div class="text-center">
                      <button type="submit" class="btn btn-lg btn-primary btn-lg w-100 mb-0">Masuk</button>
                    </div>


                    <p class="mt-3">Belum punya akun? <a href="{{ route('daftar') }}">Daftar</a></p>
                  </form>
                </div>
              </div>
            </div>
